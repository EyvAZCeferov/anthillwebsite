...
function password_toggle(e) {
    let t = document.querySelector('input[name="' + e + '"]'),
        n = document.querySelector("span#" + e + "-eye-icon");
    "password" === t.type ? (t.type = "text", n.classList.add("active"), n.innerHTML = '<i class="las la-eye-slash"></i>') : (t.type = "password", n.classList.remove("active"), n.innerHTML = '<i class="las la-eye"></i>')
}
...
function phonewriting(e) {
    var t = validPhone(document.querySelector('input[name="' + e + '"]').value);
...
function toggledropdowforcreator(e) {
    var t = document.getElementById("service-" + e).querySelector(".dropdown");
    t.classList.contains("active") ? t.classList.remove("active") : t.classList.add("active")
}

function deletequeryservice(e, t, n, a) {
    var i = document.getElementById("modal-wrapper");
    i && i.remove();
    var l = { az_delete: "Xeyir", ru_delete: "Неа", en_delete: "No", az_confirm: "Bəli", ru_confirm: "Да", en_confirm: "Yes" },
        s = `<div id="modal-wrapper">
    <div id="custom-modal">
        <p> ${n} </p>
...
function cancelmodal() {
    var e = document.getElementById("modal-wrapper");
    e && e.remove()
}

function submitdeletemodal(e, t, n) {
    sendAjaxRequest("/api/deleteservice", "post", { code: e, auth: t, lang: n }, function(e, t) {
        if (e) createalert("error", e);
        else {
            let n = JSON.parse(t);
            createalert(n.status, n.message)
        }
    }), cancelmodal(), document.getElementById(`service-${e}`).remove()
}

function createpaymentlink(e = null, t = null, n = "az", a = !0) { null != e ? sendAjaxRequest(`/api/serviceinfo/${e}`, "get", null, function(e, i) { e ? createalert("error", e) : openservicemodal(JSON.parse(i), t, n, a) }) : openservicesmodal() }

function openservicemodal(e, t = null, n = "az", a) {
    var i = document.getElementById("modal-wrapper");
    i && i.remove();
    var l = { az_allservices: "B\xfct\xfcn xidmətlər", ru_allservices: "Все услуги", en_allservices: "All services", az_service_title: "Xidmət haqqında \xfcmumi məlumat", ru_service_title: "Общая информация об услуге", en_service_title: "General information about the service", az_price: "Qiymət", en_price: "Price", ru_price: "Цена", az_createlink: "\xd6dəniş linkini yarat", ru_createlink: "Создать платежную ссылку", en_createlink: "Create payment link" },
        s = `<div id="modal-wrapper">
        <div class="modal_section">
            ...
            <div class="modal_content">
                ...
                <div class="w-100 justify">
                    <div class="clumn column-40 mobile_column-100">
...
function copyelement(e, t) {
    var n = document.querySelector("div." + e).textContent;
    navigator.clipboard.writeText(n);
    var a = document.querySelector("span." + t);
    a.innerHTML = '<i class="las la-check-circle"></i>', a.classList.add("active"), setTimeout(function() { a.innerHTML = '<i class="las la-clipboard"></i>', a.classList.remove("active") }, 1500)
}

function createandwritelink(e, t = null, n, a = "az", i) {
    sendAjaxRequest(`/api/createupayment?sender_id=${e}&receiver_id=${null!=t?t:null}&service_id=${n}&price=${document.getElementById("price_input").value}&language=${a}`, "get", null, function(e, t) {
        if (e) createalert("error", e);
...
function changetab(e) {
    ...
    var a = document.querySelectorAll(".tab_element");
    for (n = 0; n < a.length; n++) a[n].classList.remove("active");
    document.querySelector("#" + e).classList.add("active")
}
