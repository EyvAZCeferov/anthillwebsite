                    ...
                    <tr>
                      ...
                      ">
                          ...
                          "
                                        ...
                                        @if (isset($setting->social_media['whatsapp']) && !empty($setting->social_media['whatsapp']))
                                            <td align="left"
                                                style="
                        width: 25px;
                        padding: 41px 0 10px;
                        ...
                        margin-right:10px;
                      ">
                                                <a href="{{ $setting->social_media['whatsapp'] }}"
                                                    style="display: block; width: 25px; height: 25px"
                                                    target="_blank"><img alt=""
                          ...
                          "
                                        ...
                                        @if (isset($setting->social_media['tiktok']) && !empty($setting->social_media['tiktok']))
                                            <td align="left"
                                                style="
                        width: 25px;
                        padding: 41px 0 10px;
                        text-align: right;
                      ">
                                                <a href="{{ $setting->social_media['tiktok'] }}"
                                                    style="display: block; width: 25px; height: 25px"
                                                    target="_blank"><img alt=""
              ...
              ">
                            <table align="left" border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tbody>
                                    <tr>
                                        <td align="center"
                                        style="text-align: center; padding-bottom: 20px;font-size:40px;font-weight:bold;@if(env('WEBSITE_LOWERCASE_NAME')=='ev-sat.az')color:#0C24AA; @else color:#07C1B9; @endif">
                                            {{ env('APP_NAME') }}
                                        </td>
                                    </tr>
                                    <tr>
                ...
                ">
                                © {{ date("Y") }}
                                <a href="{{ env('APP_URL') }}"
                                    target="_blank">{{ env('WEBSITE_LOWERCASE_NAME') }}</a>
                            </p>
                        </td>
                    </tr>
                </tbody>
