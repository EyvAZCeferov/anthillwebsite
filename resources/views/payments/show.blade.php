        ...
        <section class="wrapper main-wrapper" style=''>
            ...
            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                <div class="page-title">
                    ...
                    <div class="pull-left">
                        <h1 class="title">{{ $data->transaction_id }} Tranzaksiya id si
                            &nbsp;&nbsp;
                            <span>
            ...
            <div class="col-lg-12 p-3 bg-white">
                ...
                @if ($data->from_id && $data->from_id != null)
                    <h1 class="py-4 px-3">Satıcı məlumatları</h1>
                    <p class="d-block justify-space-evenly">
                ...
                @if ($data->to_id && $data->to_id != null)
                    <h1 class="py-4 px-3">Alıcı məlumatları</h1>
                    <p class="d-block justify-space-evenly">
                ...
                <br>
                <div class="w-100 p-3">
                    <h1 class="py-4 px-3">Ödəniş məlumatları</h1>
                </div>
                <div class="row">
