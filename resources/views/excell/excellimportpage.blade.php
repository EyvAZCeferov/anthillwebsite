    ...
    <section class="wrapper main-wrapper" style=''>
        ...
        <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
            <div class="page-title">
                ...
                <div class="pull-left">
                    <h1 class="title">Məhsulları daxil et (toplu)
                    </h1>
                ...
                <div class="pull-right hidden-xs">
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="{{ route('excellimportPage') }}">Məhsulları daxil et (toplu)</a>
                        </li>
                        ...
                        <form action="{{ route('import') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                {{-- <div class="col-sm-12 col-md-6 col-lg-4">
                                    <select name="category" class="form-control">
                                        ...
                                        @foreach ($category as $cat)
                                            <option value="{{$cat->id}}">{{$cat->name['az_name']}}</option>
                                        @endforeach
                                    </select>
                                </div> --}}
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4">
                                    ...
                                    <input id="excell" type="file" placeholder="Excell File" class="form-control" name="excell">
                                </div>
